  ...
  return (
    ...
    >
      ...
      >
        ...
        <FadeInSection>
          <p className="font-semibold md:text-1.5xl font-alef">
            (QS Ar-Rum 21)
          </p>
        </FadeInSection>
      ...
      >
        ...
        <FadeInSection>
          ...
          >
            <img
              ...
              height="32"
            />
            <div className="grid grid-flow-col gap-4 auto-cols-max place-items-center">
              <img
        ...
        <div>
          <button
            ...
            className="py-2 px-4 bg-gold text-white font-bold uppercase transform hover:scale-105 transition-all rounded animate-bounce"
          >
